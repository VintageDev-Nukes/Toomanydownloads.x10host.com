...
$txt['default_smileyset_name'] = 'Set de Alienine';
$txt['default_aaron_smileyset_name'] = 'Set de Aaron';
$txt['default_akyhne_smileyset_name'] = 'Set de Akyhne';
$txt['default_theme_name'] = 'Tema por defecto de SMF - Curve';
...
$txt['db_sqlite_warning'] = 'Sólo recomendado para foros pequeños, con bajo volumen y/o intranets';
...
$txt['error_php_too_low'] = '¡Advertencia!  Parece que no tienes instalada una versión de PHP en tu servidor que cumpla con los <strong>requisitos mínimos para instalación</strong> que necesita SMF.<br />Si no eres el dueño del servidor, deberás solicitarle a tu proveedor de alojamiento que actualice PHP, o usar un servidor diferente - de otra manera, actualiza PHP a una versión más reciente.<br /><br />Si estás seguro que tu versión de PHP es lo suficientemente reciente puedes continuar, pero es altamente recomendado que NO lo hagas.';
...
$txt['error_db_database'] = 'El instalador no pudo acceder a la base de datos &quot;<em>%1$s</em>&quot;.  En algunos casos, necesitas crear la base de datos en tu panel de administración antes de que SMF pueda utilizarlo. Algunos además añaden prefijos (como el usuario) a tus nombres de bases de datos.';
...
$txt['upgrade_warning_out_of_date'] = '¡Este script de actualización está obsoleto! La versión actual de SMF es <em id="smfVersion" style="white-space: nowrap;">??</em> pero este script de actualización es para la <em id="yourVersion" style="white-space: nowrap;">%1$s</em>.<br /><br />Se recomienda que visites la web de <a href="http://www.simplemachines.org">Simple Machines</a> para asegurarte de que estás actualizando a la última versión.';
