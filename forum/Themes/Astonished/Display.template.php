...
function template_main()
{
			...
			<div id="forumposts">
				<div class="cat_bar">
					<h3 class="catbg">
						...
						<span class="floatright" style="font-size: 11px">(', $txt['read'], ' ', $context['num_views'], ' ', $txt['times'], ')</span>
					</h3>
				</div>';
	...
	{
		echo '
				<div style="border: 1px dashed #945290;"><p id="whoisviewing" class="smalltext">';
