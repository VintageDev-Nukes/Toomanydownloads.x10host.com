...
function template_body_above()
{
	...
	<div id="headerwrapper" style="width: ' . $settings['forum_width'] . '">' : '', '
			', template_menu(), '
...
<div id="wrapper" style="width: ' . $settings['forum_width'] . '">' : '', '';
	...
	echo '
			<img id="upshrink" src="', $settings['images_url'], '/custom/collapse.png" alt="*" title="', $txt['upshrink_description'], '" style="display: none;" />';
	echo '
	<div id="collapse_section" class="middletext"', empty($options['collapse_header']) ? '' : ' style="display: none;"', '>
	<div id="header">
		<div id="top_section">
				<a class="forumtitle" href="', $scripturl, '">', empty($context['header_logo_url_html_safe']) ? '<img src="' . $settings['images_url'] . '/custom/logo.png" alt="' . $context['forum_name'] . '" />' : '<img src="' . $context['header_logo_url_html_safe'] . '" alt="' . $context['forum_name'] . '" />', '</a>';
	...
	if ($context['user']['is_logged'])
	{
		...
		{
			echo '
				<img class="avatar" src="', $settings['images_url'], '/custom/avatardefault.png" alt="" />';
		}
		echo '
				<ul class="reset">
	...
	echo '
		...
		echo '
				...
				<div class="search"><form id="search_form" action="', $scripturl, '?action=search2" method="post" accept-charset="', $context['character_set'], '">
...
function template_body_below()
{
	...
	<div id="footer_section">';
		echo !empty($settings['forum_width']) ? '
		<div id="footerwrapper" style="width: ' . $settings['forum_width'] . '">' : '', '
		<div class="fcenter">
		<div class="fleft">
		<div class="fright">
		<div id="copyrightf">
		<ul class="reset">
			...
			<li class="copyright">', copyright_design(), '</li>
			<li class="button_xhtml"><a id="button_xhtml" href="http://validator.w3.org/check?uri=referer" target="_blank" class="new_win" title="', $txt['valid_xhtml'], '"><span>', $txt['xhtml'], '</span></a></li>
			', !empty($modSettings['xmlnews_enable']) && (!empty($modSettings['allow_guestAccess']) || $context['user']['is_logged']) ? '<li class="button_rss"><a id="button_rss" href="' . $scripturl . '?action=.xml;type=rss" class="new_win"><span>' . $txt['rss'] . '</span></a></li>' : '', '
			<li class="last button_wap2"><a id="button_wap2" href="', $scripturl , '?wap2" class="new_win"><span>', $txt['wap2'], '</span></a></li>';

	// Show the load time?
	if ($context['show_load_time'])
		echo '
		<li class="copyright">', $txt['page_created'], $context['load_time'], $txt['seconds_with'], $context['load_queries'], $txt['queries'], '</li>';
...
// Theme Copyright for noobs ;)
function copyright_design()
{
	echo '
		Astonished Theme by <a href="http://www.smfhispano.net/">Diego Andr&eacute;s</a>';
}
