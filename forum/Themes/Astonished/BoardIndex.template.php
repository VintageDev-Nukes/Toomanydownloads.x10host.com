...
function template_main()
{
	...
	<div id="newsfader">
		...
		<div class="information"><ul class="reset" id="smfFadeScroller"', empty($options['collapse_news_fader']) ? '' : ' style="display: none;"', '>';
		...
		echo '
			...
			foreach ($category['boards'] as $board)
			{
				...
				<tr id="board_', $board['id'], '" class="windowbg2">
					<td class="icon windowbg"', !empty($board['children']) ? ' rowspan="2"' : '', ' style="border-right: 1px solid #ccc; border-left: 1px solid #ccc; border-bottom: 1px solid #ccc;">
				...
				if (!empty($board['children']))
				{
					...
					<tr id="board_', $board['id'], '_children">
						<td colspan="3" class="children windowbg" style="border-right: 1px solid #ccc; border-bottom: 1px solid #ccc;">
