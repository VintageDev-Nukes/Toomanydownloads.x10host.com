...
function template_main()
{
		...
		foreach ($context['boards'] as $board)
		{
			echo '
				<tr id="board_', $board['id'], '" class="windowbg2">
					<td class="icon windowbg"', !empty($board['children']) ? ' rowspan="2"' : '', ' style="border-left: 1px solid #ccc; border-right: 1px solid #ccc; border-bottom: 1px solid #ccc;">
			...
			echo '
						...
						<div class="description_boards"><p>', $board['description'] , '</p></div>';
			...
			if (!empty($board['children']))
			{
				...
				echo '
				<tr id="board_', $board['id'], '_children"><td colspan="3" class="children windowbg" style=" border-right: 1px solid #ccc; border-bottom: 1px solid #ccc;"><strong>', $txt['parent_boards'], '</strong>: ', implode(', ', $children), '</td></tr>';
			}
		}
		echo '
				</tbody>
	...
	<div class="tborder topic_table" id="messageindex">
		...
		if (!empty($settings['display_who_viewing']))
		{
			echo '
				<tr class="windowbg2 whos_viewing">
					<td colspan="', !empty($context['can_quick_mod']) ? '6' : '5', '" class="smalltext" style="border: 1px dashed #945290;">';
		...
		foreach ($context['topics'] as $topic)
		{
			...
			echo '
				<tr>
					<td class="icon1 ', $alternate_class, '">
